...
def seed_data():
    if Product.query.count() == 0:
        products = [
            Product(name="Velvet Rose Lipstick", description="A rich, creamy lipstick in a stunning rose shade. Long-lasting formula that keeps lips moisturized all day.", price=12.99, category="lip", image_url="https://images.unsplash.com/photo-1625093742435-6fa192b6fb10?w=1600&auto=format&fit=crop&q=60&ixlib=rb-4.1.0&ixid=M3wxMjA3fDB8MHxzZWFyY2h8MjB8fGZyZWUlMjBsaXBzdGljayUyMGltYWdlc3xlbnwwfHwwfHx8MA%3D%3D"),
            Product(name="Nude Matte Lip Gloss", description="Smooth and lightweight lip gloss with a matte finish. Perfect for everyday wear.", price=8.99, category="lip", image_url="https://images.unsplash.com/photo-1626895872564-b691b6877b83?q=80&w=1528&auto=format&fit=crop&ixlib=rb-4.1.0&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D"),
